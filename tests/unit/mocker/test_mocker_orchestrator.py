...
@patch("soar_asset_mocker.mocker.mocker_orchestrator.MockOrchestrator.mockers_from_config")
@patch("soar_asset_mocker.mocker.mocker_orchestrator.MocksRegister")
def test_orchestrator_mock(register, from_config, asset_config, action_context):
